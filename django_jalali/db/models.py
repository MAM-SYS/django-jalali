...
class jDateTimeField(models.DateTimeField):
    default_error_messages = {
        "invalid": _(
            u"Enter a valid date/time in " u"YYYY-MM-DD HH:MM[:ss[.uuuuuu]] format."
        ),
    }
    ...
    def from_db_value(self, value, expression, connection):
        ...
        if value is not None and settings.USE_TZ:
            ...
            # if settings.USE_TZ and "mysql" in settings.DATABASES["default"]["ENGINE"]:
